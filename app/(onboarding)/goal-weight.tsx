...
export default function GoalWeightScreen() {
  ...
  const [selectedGoalWeight, setSelectedGoalWeight] = useState(
    onboardingData?.goalWeightKg || DEFAULT_GOAL_WEIGHT,
  );
    ...
    >
      ...
      <View className="flex-1 justify-center">
        ...
        <ScrollRuler
          minValue={MIN_WEIGHT}
          maxValue={MAX_WEIGHT}
          defaultValue={selectedGoalWeight}
          unit="kg"
          onValueChange={setSelectedGoalWeight}
        />
      </View>
