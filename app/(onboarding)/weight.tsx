...
const DEFAULT_WEIGHT = 55; // Matches reference mockup center weight
...
export default function WeightScreen() {
  ...
  const initialWeight = onboardingData?.weightKg || DEFAULT_WEIGHT;
  ...
  useEffect(() => {
    const initialIndex = initialWeight - MIN_WEIGHT;
